...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-640-erd-s-problem-640-0bcf871a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-640"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-640-erd-s-problem-640-0bcf871a-v1",
      "problem_contract_sha256": "2ddf17230bdc905fc75a61e830039afffbba42a69debdabfd189c7ef2056dfff",
      "problem_id": "problem:um-ep-640-erd-s-problem-640-0bcf871a",
      "route_id": "route:um-ep-640-erd-s-problem-640-0bcf871a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-640-erd-s-problem-640-0bcf871a-source-fidelity-01",
      "graph_id": "graph:um-ep-640-erd-s-problem-640-0bcf871a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-640-erd-s-problem-640-0bcf871a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-640-erd-s-problem-640-0bcf871a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there some function $f$ such that for all $k\\geq 3$ if a finite graph $G$ has chromatic number $\\geq f(k)$ then $G$ must contain some odd cycle whose vertices span a graph of chromatic number $\\geq k$? \", \"difficulty\": \"L1\" },{"
          },
          "statement_sha256": "7e378778400858abe33b3af3b1e3d4baebcf7f72208279a1b9be0b1d13b3795a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-640-erd-s-problem-640-0bcf871a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-640-erd-s-problem-640-0bcf871a-root",
      "route_id": "route:um-ep-640-erd-s-problem-640-0bcf871a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-640-b28bc2449d80",
        "url": "https://www.unsolvedmath.com/problems/EP-640"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
